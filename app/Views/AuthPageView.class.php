...
class AuthPageView implements IView
{
    ...
    public function printOutput(array $tplData)
    {
        ...
        <div class="justify-content-center d-inline-flex mx-5">
            <div class="card text-white bg-dark border col-lg-5 col-12 py-3 px-5">
                <form method="post">
                    ...
                    <div class="mb-3">
                        <button type="submit" name="submit" value="login" class="btn btn-primary">Přihlásit</button>
                    </div>
                </form>
                <hr>
                <a class="link-primary btn-violet" href="#">Zapomenuté heslo</a>
            </div>
        ...
        <?php
            ...
            ?>
            <h1 class="display-1 text-center fw-bold my-5">Registrace:</h1>
            <div class="justify-content-center d-inline-flex mx-5">
                <div class="card text-white bg-dark border col-lg-5 col-12 py-3 px-5">
                    <form method="post">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="email" id="email" name="email" class="form-control" placeholder="Email" oninput="validateEmail()" required>
                        </div>
                        <label for="username" class="form-label">*Uživatelské jméno:</label>
                        <div class="input-group mb-3">
                                    <span class="input-group-text">
                            ...
                            <input type="text" id="username" name="username" class="form-control" placeholder="Uživatelské jméno" oninput="validateUsername()" required>
                        </div>
