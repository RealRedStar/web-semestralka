...
/**
 * Třída reprezentuje šablonu pro kampaň
 */
            ...
            <div class="d-flex justify-content-center">
                <div id="match-div" class="card card-text text-white bg-dark mb-3 mx-5 my-5 border col-lg-8 col-12">
                    ...
                    <div class="card-body">
                        ...
                        // kontrola zda hra již hra neskončila
                        if ($isFinished) {
...
?>
                        ...
                        <?php
                            $permissions = $loggedUser->getRole()->getPermissions();
                            // vypsání tabulky s vyhozenými hráči
